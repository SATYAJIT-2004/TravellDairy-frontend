...
const PasswordInput = ({value, onChange, placeholder}) => {
  ...
  return (
    <div className='flex items-center bg-cyan-600/5 px-5 rounded-sm mb-3'>
        <input value = {value} onChange={onChange} placeholder={placeholder || 'Enter your password'} className='w-full text-sm bg-transparent py-3 mr-3 rounded-sm outline-hidden' type={isShowPassword ? "text" : "password" } />
