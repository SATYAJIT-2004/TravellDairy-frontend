   ...
   try{
    dispatch(signInStart())
      ...
      if(response.data){
        ...
        dispatch(signInFailure("Unexpected error occured"))
      }
   }catch(error){
     dispatch(signInFailure("Unexpected error occured"))
    ...
    <div className="h-screen bg-cyan-50 overflow-hidden relative">
      ...
      <div className='login-ui-box right-10 -top-40' />
       ...
       <div className="container h-screen flex items-center justify-center px-20 mx-auto">
          ...
          <div>
            <h4 className='text-5xl text-white font-semibold leading-[58px]'>Create your <br /> Stories</h4>
            <p className="text-[15px] text-white leading-6 pr-7 mt-4">Record your travel experience and memories in your travel journey</p>
          </div>
          </div>
